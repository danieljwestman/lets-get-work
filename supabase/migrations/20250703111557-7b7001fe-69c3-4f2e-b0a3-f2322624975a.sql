-- Drop and recreate the public opportunity functions to include video URLs
DROP FUNCTION IF EXISTS public.get_public_opportunity_by_profile(text, text);
DROP FUNCTION IF EXISTS public.get_public_opportunity_with_id(text);

      ...
      <div className="text-center pb-16 px-6">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="relative">
            ...
            {/* Content container */}
            <div className="relative p-12 sm:p-16 space-y-12">
              
              {/* Crafted with care section - enhanced */}
              <div className="space-y-4">
                <p className="text-gray-700 text-lg sm:text-xl leading-relaxed font-light max-w-2xl mx-auto">
              ...
              <div className="space-y-8">
                ...
                {/* LetsGetWork logo with stunning styling */}
                <div className="relative inline-block">
                  ...
                  {/* Main logo text */}
                  <div className="relative">
                    <div className="text-4xl sm:text-5xl md:text-6xl font-black bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 bg-clip-text text-transparent tracking-tight leading-none">
                      LetsGetWork
                    </div>
                    
                    {/* Subtle reflection effect */}
                    <div className="absolute inset-0 text-4xl sm:text-5xl md:text-6xl font-black bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-blue-700/20 bg-clip-text text-transparent tracking-tight leading-none transform translate-y-1 blur-sm -z-10">
                      LetsGetWork
                    </div>
                  </div>
                </div>
              ...
              {/* Experimental showcase description - enhanced */}
              <div className="space-y-2">
                <div className="inline-block max-w-3xl">
                  <div className="bg-gradient-to-br from-white/80 to-gray-50/60 border border-gray-200/60 rounded-2xl px-8 py-6 shadow-lg backdrop-blur-sm relative overflow-hidden">
